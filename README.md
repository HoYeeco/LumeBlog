...
## 项目概述
LumeBlog是一个基于SSM（Spring + Spring MVC + MyBatis）框架开发的博客系统，支持文章发布、阅读、分类管理、用户登录等核心功能。系统采用前后端分离思想，前端使用Vue.js构建用户界面，后端提供RESTful API接口，实现了完整的博客生命周期管理。
